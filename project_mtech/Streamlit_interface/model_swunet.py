# -*- coding: utf-8 -*-
"""
Created on Tue Feb 24 16:20:57 2026
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=32, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        ...
        #print(nn.Conv2d(in_chans, embed_dim,
         #                     kernel_size=patch_size, stride=patch_size))
        if norm_layer is not None:
            self.norm = norm_layer(embed_dim)
          #  print(norm_layer(embed_dim))
        else:
            self.norm = None
...
class SwinUnet(nn.Module):
    def __init__(self, img_size=224, num_classes=1, zero_head=False, vis=False):
        ...
        #self.config = config
#drop_path_rate=0.5, drop_rate=0.1, attn_drop_rate=0.1
        self.swin_unet = SwinTransformerSys(img_size=224, patch_size=4, in_chans=3, num_classes=1,
    ...
    def load_from(self, config):
        ...
        #"C:\\Users\\yvonneng\\Downloads\\swin_tiny_patch4_window7_224.pth"
